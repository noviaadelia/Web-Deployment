...
def predict():
    ...
    # Hasil model training yang disimpan pada effnetmod5.h5
    model = load_model('mod5.h5')
    file = request.files["file"]
    # untuk menyimpan file yang diunggah ke sistem file
    file.save(os.path.join('static', 'temp.jpg'))
    # Fungsi ini membaca gambar dari file "temp.jpg" dan mengonversinya menjadi format yang dapat digunakan oleh model
    ...
    return predict_result('mod5.h5', runtimes, respon_model, 'temp.jpg')
